...
void TutorialLogo::Init()
{
	//m_Position = D3DXVECTOR3(SCREEN_WIDTH - 250.0f, 100.0f, 0.0f);
	...
	D3DX11CreateShaderResourceViewFromFile(Renderer::GetDevice(),
		"asset/texture/tutorialTex1.png",
		NULL,
		NULL,
		&m_Texture,
		NULL);
...
void TutorialLogo::Draw()
{
	...
	vertex[0].Position = D3DXVECTOR3(m_Position.x - 250.0f, m_Position.y - 100.0f, m_Position.z);			//座標
	vertex[0].Normal = D3DXVECTOR3(0.0f, 0.0f, 0.0f);			//法線ベクトル
