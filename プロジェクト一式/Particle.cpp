...
void Particle::Init()
{
	...
	vertex[0].Position = D3DXVECTOR3(m_Position.x - 3.0f, m_Position.y - 3.0f, 0.0f);			//座標
	...
	vertex[1].Position = D3DXVECTOR3(m_Position.x + 3.0f, m_Position.y - 3.0f, 0.0f);
	vertex[1].Normal = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
	vertex[1].Diffuse = D3DXVECTOR4(1.0f, 0.0f, 0.0f, 1.0f);
	vertex[1].TexCoord = D3DXVECTOR2(1.0f, 0.0f);

	vertex[2].Position = D3DXVECTOR3(m_Position.x - 3.0f, m_Position.y + 3.0f, 0.0f);
	vertex[2].Normal = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
	vertex[2].Diffuse = D3DXVECTOR4(1.0f, 0.0f, 0.0f, 1.0f);
	vertex[2].TexCoord = D3DXVECTOR2(0.0f, 1.0f);

	vertex[3].Position = D3DXVECTOR3(m_Position.x + 3.0f, m_Position.y + 3.0f, 0.0f);
